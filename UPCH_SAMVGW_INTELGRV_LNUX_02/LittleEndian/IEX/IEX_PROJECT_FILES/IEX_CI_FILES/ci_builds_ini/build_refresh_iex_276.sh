...
if [ "$PLATFORM" == "gateway" ]; then 
	...
	FLASHTOOL_ROOT=$BUILD_OUT_ROOT/UPCH_SAMVGW_INTELGRV_LNUX_02/LittleEndian/IEX/IEX_PROJECT_FILES/IEX_INI_FILES
	...
	cd $DRIVERS_ROOT/
	chmod 777 sw_version_modifier.exe
	./sw_version_modifier.exe $DRIVERS_ROOT/UPC_SAM_VGW.bin 16777276
	mv -f $DRIVERS_ROOT/UPC_SAM_VGW.bin.version_0x100003c $DRIVERS_ROOT/bzImage
	...
	cd $DRIVERS_ROOT/
	chmod 777 sw_version_modifier.exe
	./sw_version_modifier.exe $DRIVERS_ROOT/UPC_SAM_IPC.bin 16777276
	mv -f $DRIVERS_ROOT/UPC_SAM_IPC.bin.version_0x100003c $DRIVERS_ROOT/bzImage	
fi
