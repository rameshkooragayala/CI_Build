...
//FullSanity-0805-EPG-programme-grid
public class FullSanity_0805 : _Test
{
    [ThreadStatic]
    static _Platform CL;
    ...
    public override void CreateStructure()
    {
        ...
        //Brief Description: FullSanity-0805-EPG-programme-grid
    ...
    private class Step3 : _Step
    {
        public override void Execute()
        {
            ...
            if (!res.CommandSucceeded)
            {
                FailStep(CL, res, "Failed to Navigate to TV GUIDE BY SINGLE CHANNEL");
            }
