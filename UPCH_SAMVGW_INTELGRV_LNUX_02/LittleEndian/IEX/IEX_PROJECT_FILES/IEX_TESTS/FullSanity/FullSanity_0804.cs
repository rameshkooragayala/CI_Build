...
//FullSanity-0804-EPG-Action-menu
public class FullSanity_0804 : _Test
{
    [ThreadStatic]
    static _Platform CL;
    ...
    private class Step1 : _Step
    {
        public override void Execute()
        {
            ...
            //Verify for the option A/V Settings
            ...
            //Navigate within the Make Favourite
            ...
            if (CL.EA.Project.Name.ToUpper() != "ISTB")
            {
                ...
                //Verify for the option Record
                res = CL.IEX.MilestonesEPG.SelectMenuItem("RECORD");
                if (!res.CommandSucceeded)
                {
                    FailStep(CL, res, "Failed to Select Menu Item RECORD");
                }
            }
