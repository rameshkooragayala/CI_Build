...
public class FullSanity_0408 : _Test
{
    ...
    static Service subtitleService1;
    static Service subtitleService2;
    ...
    private class PreCondition : _Step
    {
        public override void Execute()
        {
            ...
            subtitleService1 = CL.EA.GetServiceFromContentXML("Type=Video", "ParentalRating=High;NoOfSubtitleLanguages=0");
            ...
            subtitleService2 = CL.EA.GetServiceFromContentXML("Type=Video", "ParentalRating=High;LCN=" + subtitleService1.LCN + ";NoOfSubtitleLanguages=0");
    ...
    private class Step1 : _Step
    {
        ...
        public override void Execute()
        {
            ...
            res = CL.EA.ChannelSurf(EnumSurfIn.Live, subtitleService1.LCN);
            if (!res.CommandSucceeded)
            {
    ...
    private class Step4 : _Step
    {
        ...
        public override void Execute()
        {
            ...
            res = CL.EA.ChannelSurf(EnumSurfIn.Live, subtitleService2.LCN);
            if (!res.CommandSucceeded)
            {
                FailStep(CL, res, "Failed to Tune to Channel With DCA");
            }
