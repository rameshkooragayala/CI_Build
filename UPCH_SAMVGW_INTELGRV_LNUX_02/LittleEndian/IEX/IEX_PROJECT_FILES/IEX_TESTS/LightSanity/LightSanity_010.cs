...
//LightSanity-010-SET-Factory_Reset
public class LightSanity_010 : _Test
{
    [ThreadStatic]
    static _Platform CL;
    ...
    public override void CreateStructure()
    {
        ...
        //Brief Description: LightSanity-010-SET-Factory_Reset
    ...
    private class Step2 : _Step
    {
        public override void Execute()
        {
            ...
            res = CL.IEX.Debug.BeginWaitForMessage("bin/sh", 0, 120, IEXGateway.DebugDevice.Serial);
            if (!res.CommandSucceeded)
            {
