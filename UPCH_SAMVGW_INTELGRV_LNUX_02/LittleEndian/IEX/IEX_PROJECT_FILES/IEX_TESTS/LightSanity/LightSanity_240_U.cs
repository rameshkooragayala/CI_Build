...
public class LightSanity_240_U : _Test
{
    [ThreadStatic]
    static _Platform CL;
    ...
    private class PreCondition : _Step
    {
        public override void Execute()
        {
            ...
            res = CL.EA.STBSettings.SetParentalControlAgeLimit(EnumParentalControlAge.FSK_6);
            if (!res.CommandSucceeded)
            {
    ...
    public override void PostExecute()
    {
        ...
        res = CL.EA.STBSettings.SetParentalControlAgeLimit(EnumParentalControlAge.FSK_18);
        if (!res.CommandSucceeded)
        {
            LogComment(CL, "Failed to Set Parental Control Age Limit to FSK_18");
        }
