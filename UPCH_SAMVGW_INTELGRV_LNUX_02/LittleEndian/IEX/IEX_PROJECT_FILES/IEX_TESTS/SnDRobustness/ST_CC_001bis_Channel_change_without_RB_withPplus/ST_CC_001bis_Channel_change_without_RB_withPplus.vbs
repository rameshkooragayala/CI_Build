...
Sub Initialize()
   ...
   If TestOptions_UserBitmapPath = Empty Then
   	BMP_Path = "O:\TestScripts\ST_CC_001bis_Channel_change_without_RB_withPplus"
   Else
   ...
   If TestOptions_SetLogHeader = Empty Or TestOptions_SetLogHeader = True Then IEX.LogHeader "Test: " & "ST_CC_001bis_Channel_change_without_RB_withPplus" & ".", false, false, false, 14, "Black"
