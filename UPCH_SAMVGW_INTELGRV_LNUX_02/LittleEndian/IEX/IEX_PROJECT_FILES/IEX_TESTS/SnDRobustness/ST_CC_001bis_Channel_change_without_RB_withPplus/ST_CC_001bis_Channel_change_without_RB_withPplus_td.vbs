...
'Sub Main()
	'Initialize
        ...
        '****h* S&D robustness script/ST_CC_001bis_Channel_change_without_RB_withPplus
        '* TITLE
        '*  ST_CC_001bis_Channel_change_without_RB_withPplus
        TEST_NAME ="ST_CC_001bis_Channel_change_without_RB_withPplus"
        TEST_CODE = "ST_CC_001bis"
...
'* UserLib v3.00
        ...
        '* Since the begin of the PHASE2, the script ST_CC_001 has been modified, now a zapping P+ replace the zappings P+ then P-
        '* v3.00
...
Sub Initialize()
   ...
   'BMP_Path = "C:\Program Files\IEX" & tempTestLoc & "ST_CC_001bis_Channel_change_without_RB_withPplus" & "_" & BMPSet & "_" & IP & "_" & ServerNo
   'BMP_Set = BMPSET 'Already set in Test_Main
   TEST_NAME = "ST_CC_001bis_Channel_change_without_RB_withPplus"
   IEX.BitmapSet = BMP_Set
   IEX.BitmapSetTable = BMP_Path  & "\ST_CC_001bis_Channel_change_without_RB_withPplus.xml"

   IEX.LogHeader "Test: ST_CC_001bis_Channel_change_without_RB_withPplus."
...
Sub Test_Main(byval Debug, ByVal CurrentTestSet, ByVal CurrentTest, ByVal CurrentRun)
    ...
    strScriptFolder = "C:\Program Files\IEX\" & tempScriptLoc & "_" & "ST_CC_001bis_Channel_change_without_RB_withPplus" & BMPSet & "_" & IP & "_" & ServerNo
    Call createFolderStruct(strScriptFolder)
    strLogFileNameXML = strScriptFolder  & "\TD_" & "ST_CC_001bis_Channel_change_without_RB_withPplus" & ".xml"
    strLogFileNameXSL = strScriptFolder  & "\TD_" & "ST_CC_001bis_Channel_change_without_RB_withPplus" & ".xsl"
	...
	TDOutput.Print "Test " & CurrentTest.Test.Name & " - Test begins."
        ...
        BMP_Path = "C:\Program Files\IEX\" & tempTestLoc & "_" & "ST_CC_001bis_Channel_change_without_RB_withPplus" & BMPSet & "_" & IP & "_" & ServerNo
	BMP_Set = BMPSET
