...
Sub Initialize()
   ...
   If TestOptions_SetLogHeader = Empty Or TestOptions_SetLogHeader = True Then IEX.LogHeader "Test: " & "ST_CC_002bis_Channel_change_with_RB_withPplus" & ".", false, false, false, 14, "Black"
