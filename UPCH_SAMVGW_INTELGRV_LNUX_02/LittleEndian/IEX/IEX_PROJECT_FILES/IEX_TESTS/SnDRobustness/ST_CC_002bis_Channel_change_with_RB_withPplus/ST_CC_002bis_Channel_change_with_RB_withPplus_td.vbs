...
Sub Initialize()
   ...
   'BMP_Path = "C:\Program Files\IEX" & tempTestLoc & "ST_CC_002bis_Channel_change_with_RB_withPplus" & "_" & BMPSet & "_" & IP & "_" & ServerNo
...
Sub Test_Main(byval Debug, ByVal CurrentTestSet, ByVal CurrentTest, ByVal CurrentRun)
    ...
    strScriptFolder = "C:\Program Files\IEX\" & tempScriptLoc & "_" & "ST_CC_002bis_Channel_change_with_RB_withPplus" & BMPSet & "_" & IP & "_" & ServerNo
    Call createFolderStruct(strScriptFolder)
    strLogFileNameXML = strScriptFolder  & "\TD_" & "ST_CC_002bis_Channel_change_with_RB_withPplus" & ".xml"
    strLogFileNameXSL = strScriptFolder  & "\TD_" & "ST_CC_002bis_Channel_change_with_RB_withPplus" & ".xsl"
	...
	TDOutput.Print "Test " & CurrentTest.Test.Name & " - Test begins."
        ...
        BMP_Path = "C:\Program Files\IEX\" & tempTestLoc & "_" & "ST_CC_002bis_Channel_change_with_RB_withPplus" & BMPSet & "_" & IP & "_" & ServerNo
	BMP_Set = BMPSET
