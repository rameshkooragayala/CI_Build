...
Sub Initialize()
   ...
   If TestOptions_UserBitmapPath = Empty Then
   	BMP_Path = "O:\TestScripts\ST_CC_007_3Pplus_2Pminus"
   Else
   ...
   If TestOptions_SetLogHeader = Empty Or TestOptions_SetLogHeader = True Then IEX.LogHeader "Test: " & "ST_CC_007_3Pplus_2Pminus" & ".", false, false, false, 14, "Black"
