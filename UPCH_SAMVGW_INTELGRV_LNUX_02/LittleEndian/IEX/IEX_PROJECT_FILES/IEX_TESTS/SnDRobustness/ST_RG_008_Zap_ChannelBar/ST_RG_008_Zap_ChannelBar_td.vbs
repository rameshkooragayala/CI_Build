...
Sub Initialize()
   ...
   'BMP_Path = "C:\Program Files\IEX" & tempTestLoc & "ST_RG_008_Zap_ChannelBar" & "_" & BMPSet & "_" & IP & "_" & ServerNo
...
Sub Test_Main(byval Debug, ByVal CurrentTestSet, ByVal CurrentTest, ByVal CurrentRun)
    ...
    strScriptFolder = "C:\Program Files\IEX\" & tempScriptLoc & "_" & "ST_RG_008_Zap_ChannelBar" & BMPSet & "_" & IP & "_" & ServerNo
    Call createFolderStruct(strScriptFolder)
    strLogFileNameXML = strScriptFolder  & "\TD_" & "ST_RG_008_Zap_ChannelBar" & ".xml"
    strLogFileNameXSL = strScriptFolder  & "\TD_" & "ST_RG_008_Zap_ChannelBar" & ".xsl"
	...
	TDOutput.Print "Test " & CurrentTest.Test.Name & " - Test begins."
        ...
        BMP_Path = "C:\Program Files\IEX\" & tempTestLoc & "_" & "ST_RG_008_Zap_ChannelBar" & BMPSet & "_" & IP & "_" & ServerNo
	BMP_Set = BMPSET
