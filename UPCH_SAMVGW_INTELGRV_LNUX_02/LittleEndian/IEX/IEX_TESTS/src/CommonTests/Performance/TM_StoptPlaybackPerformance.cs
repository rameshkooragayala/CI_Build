/// <summary>
///  Script Name : TM_StoptPlaybackPerformance.cs
///  Test Name   : TM_StoptPlaybackPerformance
///  TEST ID     : 
///  QC Version  : 
///  Variations from QC:
/// ----------------------------------------------- 
...
[Test("TM_StoptPlaybackPerformance")]
public class TM_StoptPlaybackPerformance : _Test
{
    [ThreadStatic]
    static _Platform CL;
    ...
    private class Step1 : _Step
    {
        ...
        public override void Execute()
        {
            ...
            for (int i = 1; i <= numberOfIteration; i++)
            {
                ...
                LogComment(CL, "Playback from Archive for StopPlayback.Iteration : " + i.ToString());
              ...
              if (!res.CommandSucceeded)
              {
                  FailStep(CL, res, "Failed to Check for video AV is getting lost ");
              }
            }
