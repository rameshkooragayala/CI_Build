/// <summary>
///  Script Name : TM_PausePlaybackPerformance.cs
///  Test Name   : TM_PausePlaybackPerformance
///  TEST ID     : 
///  QC Version  : 
///  Variations from QC:
/// ----------------------------------------------- 
...
[Test("TM_PausePlaybackPerformance")]
public class TM_PausePlaybackPerformance : _Test
{
    [ThreadStatic]
    static _Platform CL;
    ...
    private class PreCondition : _Step
    {
        public override void Execute()
        {
            ...
            if (string.IsNullOrEmpty(item))
            {
                ...
                FailStep(CL, "Failed to fetch ITEM  items in TEST PARAMS from the Test ini file!");
            }
    ...
    private class Step1 : _Step
    {
        ...
        public override void Execute()
        {
            ...
            for (int i = 1; i <= numberOfIteration; i++)
            {
                ...
                LogComment(CL, "Playback from Archive for PausePlayback.Iteration : " + i.ToString());
                ...
                LogComment(CL, "Verifying PLAYBACK state as it is needed to launch action bar ");
                if ((CL.EA.UI.Utils.VerifyState("PLAYBACK")).Equals (false))
                {
                    
                    FailStep(CL, res, "Failed to get PLAYBACK state");
                ...
                LogComment(CL,"Time taken by the scenario in milli seconds after subtracting value of startlines from endlines:" + timedifference.ToString(), true);
            ...
            double thresholdValue = Convert.ToInt32(threshold);
