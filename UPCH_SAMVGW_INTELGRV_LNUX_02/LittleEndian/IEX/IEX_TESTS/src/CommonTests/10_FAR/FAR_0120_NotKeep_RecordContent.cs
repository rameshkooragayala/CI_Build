/// <summary>
///  Script Name : FAR_0120_NotKeep_RecordContent.cs
///  Test Name   : FAR-0120-Not Keep recorded content
///  TEST ID     : 68965
///  QC Version  : 1
...
[Test("FAR_0120_VerifyDeleteRecords")]
public class FAR_0120 : _Test
{
    /**
    ...
    /**
     * @brief   Step 2: Verify recorded content is not present even after factory reset.
     */

    private const string STEP2_DESCRIPTION = "Step 2: Verify recorded content is not present even after factory reset";
    ...
    private class Step2 : _Step
    {
        ...
        public override void Execute()
        {
            ...
            //Recordings should not be present
            res = CL.EA.PVR.VerifyEventInArchive("Event",true,false);
            if (!res.CommandSucceeded )
            {
    ...
    public class Step3 : _Step
    {
        ...
        public override void Execute()
        {
            ...
            //Verify if the Bookings are deleted
