/// <summary>
///  Script Name : LIVE_0901_FZ_Up.cs
///  Test Name   : LIVE-0901-Fast Zapping-Up
///  TEST ID     :
///  QC Version  :
/// -----------------------------------------------
...
public class LIVE_0901 : _Test
{
    ...
    public override void CreateStructure()
    {
        ...
        this.AddStep(new Step3(), "Step 3: Tune To Channel S3, Using Upwards Direction");
    ...
    {
        //Step 1: Tune To Channel S1 After Standby
        public override void Execute()
        {
            StartStep();
    ...
    {
        //Step 2: Tune To Channel S2, Using Upwards Direction
