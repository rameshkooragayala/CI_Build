/// <summary>
///  Script Name : BOOK_0103_TimeBased_Weekend_ReoccurringFromPlanner.cs
///  Test Name   : BOOK-0103-Time Based-Weekend-Reoccurring From Planner
///  TEST ID     : 60967
///  QC Version  : 2
/// -----------------------------------------------
...
public class BOOK_0103_Weekend : _Test
{
    [ThreadStatic]
    ...
    private class Step1 : _Step
    {
        public override void Execute()
        {
            ...
            res = CL.EA.PVR.RecordManualFromPlanner("MR1", ChannelName, "13:00", 60, 1, EnumFrequency.WEEKEND, true, false);
