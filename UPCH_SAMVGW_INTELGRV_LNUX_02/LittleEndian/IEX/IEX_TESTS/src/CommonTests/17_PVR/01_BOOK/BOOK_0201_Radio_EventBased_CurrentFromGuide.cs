/// <summary>
///  Script Name : BOOK_0201_Radio_EventBased_CurrentFromGuide.cs
///  Test Name   : BOOK-0201--Radio-Event Based-Current From Guide
///  TEST ID     : 61251
///  QC Version  : 2
/// -----------------------------------------------
...
public class BOOK_0201_Radio : _Test
{
    [ThreadStatic]
    ...
    private class PreCondition : _Step
    {
        public override void Execute()
        {
            ...
            serviceToBeCurrentRecorded = CL.EA.GetValue("First_of_2_Consecutive_Radio_Service");
    ...
    private class Step1 : _Step
    {
        public override void Execute()
        {
            ...
            //Check for video not required for a Radio service
    ...
    private class Step2 : _Step
    {
        public override void Execute()
        {
            ...
            res = CL.EA.PVR.RecordCurrentEventFromGuide(currentEventRecording, serviceToBeCurrentRecorded, ReturnToLive:false);
            if (!res.CommandSucceeded)
            {
