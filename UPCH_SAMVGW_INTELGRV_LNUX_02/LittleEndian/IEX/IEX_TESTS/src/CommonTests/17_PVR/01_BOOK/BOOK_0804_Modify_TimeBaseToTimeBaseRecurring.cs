/// <summary>
///  Script Name : BOOK_0804_Modify_TimeBaseToTimeBaseRecurring.cs
///  Test Name   : BOOK-0804-Modify-Time Base To Time Base Recurring
///  TEST ID     :
///  QC Version  :
/// -----------------------------------------------
...
public class BOOK_0804 : _Test
{
    ...
    public override void CreateStructure()
    {
        ...
        this.AddStep(new Step2(), "Step 2: Modify From Time Base To Time Base Recurring ( Frequency  Daily )");
        this.AddStep(new Step3(), "Step 3: Verify That Modification of Time Base Recording To Time Base Recurring Succeed");
