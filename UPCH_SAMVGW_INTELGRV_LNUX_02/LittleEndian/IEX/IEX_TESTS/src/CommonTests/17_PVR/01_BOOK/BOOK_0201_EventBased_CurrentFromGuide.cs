/// <summary>
///  Script Name : BOOK_0201_EventBased_CurrentFromGuide.cs
///  Test Name   : BOOK-0201-Event Based-Current From Guide
///  TEST ID     : 61251
///  QC Version  : 2
/// -----------------------------------------------
...
public class BOOK_0201 : _Test
{
    ...
    private class Step2 : _Step
    {
        public override void Execute()
        {
            ...
            res = CL.EA.PVR.RecordCurrentEventFromGuide(currentEventRecording, serviceToBeCurrentRecorded);
            if (!res.CommandSucceeded)
            {
