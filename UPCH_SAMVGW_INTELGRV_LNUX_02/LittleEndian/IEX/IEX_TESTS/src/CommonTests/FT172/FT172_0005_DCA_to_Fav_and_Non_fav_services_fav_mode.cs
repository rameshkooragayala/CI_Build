...
public class FT172_0005 : _Test
{
    ...
    private class PreCondition : _Step
    {
        public override void Execute()
        {
            ...
            string _favoriteChannelList = String.Join(",", favoriteChannelNumList);
            ...
            res = CL.EA.STBSettings.SetFavoriteChannelNumList(_favoriteChannelList, EnumFavouriteIn.Settings);
            if (!res.CommandSucceeded)
            {
    ...
    private class Step5 : _Step
    {
        public override void Execute()
        {
            ...
            CL.EA.ChannelSurf(EnumSurfIn.Live, "0");
