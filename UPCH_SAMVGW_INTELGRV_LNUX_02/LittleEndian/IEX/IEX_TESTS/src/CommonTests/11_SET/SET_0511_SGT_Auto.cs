/// <summary>
///  Script Name : SET_0511_SGT_Auto.cs
///  Test Name   : SET-0511-REC SGT-Auto
///  TEST ID     :
///  QC Version  :
/// -----------------------------------------------
...
public class SET_0511 : _Test
{
    ...
    private static int startGuardTime = 5;
    private static int TimeLeft = 0;
    private static int TimeLeftRecordedEvent = 0;
    private static string StartGuardTimeName = "AUTOMATIC";
    ...
    private class PreCondition : _Step
    {
        ...
        {
            StartStep();
            startGuardTime = Convert.ToInt32(CL.EA.GetValueFromINI(EnumINIFile.Test, "TEST PARAMS", "SGT"));
