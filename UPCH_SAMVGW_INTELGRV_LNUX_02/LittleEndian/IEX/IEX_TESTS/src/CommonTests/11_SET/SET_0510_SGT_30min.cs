/// <summary>
///  Script Name : SET_0510_SGT_30min.cs
...
public class SET_0510_30 : _Test
{
    [ThreadStatic]
    ...
    private static int startGuardTime = 30;
    private static int TimeLeft = 0;
    private static int TimeLeftRecordedEvent = 0;
    private static string StartGuardTimeName = "30 min.";
    ...
    private class PreCondition : _Step
    {
        public override void Execute()
        {
            ...
            Short_SD_2 = CL.EA.GetValue("FTA_1st_Mux_3");
