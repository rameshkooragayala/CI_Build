/// <summary>
///  Script Name : SET_0510_SGT_2min.cs
...
public class SET_0510_2 : _Test
{
    ...
    private static int startGuardTime = 2;
    private static int TimeLeft = 0;
    private static int TimeLeftRecordedEvent = 0;
    private static string StartGuardTimeName = "2 min.";
    ...
    private class PreCondition : _Step
    {
        public override void Execute()
        {
            ...
            Short_SD_2 = CL.EA.GetValue("Multiple_Audio_2");
