/// <summary>
///  Script Name : SET_Subtitle_Enable_PLB.cs
///  Test Name | TEST ID: SET-SUBT-0014-Playback-Subtitle enable
///  Test Name | TEST ID: SET-SUBT-0018-Playback-subtitle-format-non-default
///  Test ID     : 71563,71566
...
[Test("SET_Subtitle_Enable_PLB")]
public class SET_Subtitle_Enable_PLB : _Test
{
    [ThreadStatic]
    static _Platform CL;
    ...
    private const string STEP2_DESCRIPTION = "Step 2: Verify that Subtitles are getting displayed during the playback.";
    ...
    private class Step2 : _Step
    {
        ...
        {
            StartStep();
            // while the playback is going on, Verify the presence of Subtitles(Since it has been enabled in the precondition.)
            ...
            SubtEnable = CL.EA.GetValueFromINI(EnumINIFile.Project, "SUBTITLE", "ENABLE");
            if (SubtEnable == "")
            {
                FailStep(CL, "Field DISABLE is not available in the SUBTITLE section.");
            }

            if (SubtState != SubtEnable)
            {
