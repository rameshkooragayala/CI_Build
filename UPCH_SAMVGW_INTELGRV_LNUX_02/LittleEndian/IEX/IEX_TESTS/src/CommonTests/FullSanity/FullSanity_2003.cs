...
public class FullSanity_2003 : _Test
{
    ...
    private class Step1 : _Step
    {
        public override void Execute()
        {
            ...
            CL.IEX.SendIRCommand("SELECT_RIGHT", -1, ref timestamp);
            ...
            CL.IEX.SendIRCommand("SELECT_RIGHT", -1, ref timestamp);    // --> Naruto
            //CL.IEX.SendIRCommand("SELECT_RIGHT", -1, ref timestamp);  // --> Ocean 11
            // END FRED
    ...
    private class Step3 : _Step
    {
        public override void Execute()
        {
            ...
            CL.IEX.SendIRCommand("SELECT", -1, ref timestamp);
            CL.IEX.SendIRCommand("SELECT_UP", -1, ref timestamp);
            CL.IEX.SendIRCommand("SELECT_LEFT", -1, ref timestamp);    // --> Shrek with sub...
            //CL.IEX.SendIRCommand("BACK", -1, ref timestamp);
            ...
            if (CL.EA.UI.Vod.GetAssetSubscriptionStatus() != EnumSubscriptionStatus.SUBSCRIBED ) 
            {
                FailStep(CL, res, "Wrong information displayed. Expected: 'AVAILABLE - Genre'");
            }
