...
public class FullSanity_0806 : _Test
{
    ...
    private class PreCondition : _Step
    {
        public override void Execute()
        {
            ...
            videoService = CL.EA.GetValueFromINI(EnumINIFile.Test, "TEST PARAMS", "videoService");
            if (String.IsNullOrEmpty(videoService))
            {
                videoService = "2";
            }
            PassStep();
    ...
    private class Step1 : _Step
    {
        public override void Execute()
        {
            ...
            res = CL.EA.ChannelSurf(EnumSurfIn.Live, videoService);
    ...
    private class Step2 : _Step
    {
        public override void Execute()
        {
			...
			CL.IEX.Wait(5);
            CL.EA.UI.Utils.SendChannelAsIRSequence("720");
            CL.IEX.Wait(5);
