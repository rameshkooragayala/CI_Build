...
public class FullSanity_0906 : _Test
{
    ...
    private class PreCondition : _Step
    {
        public override void Execute()
        {
            ...
            //Setting the EGT value
            egtFriendlyName = CL.EA.GetValueFromINI(EnumINIFile.Test, "TEST PARAMS", "EGT_VAL");
            if (egtFriendlyName == "")
            {
                LogCommentFailure(CL, "egtFriendlyName is not defined in the Test ini file");
            }
            else
            {
                ...
                {
                    LogCommentFailure(CL,"Failed to Set the EGT to " + egtFriendlyName);
                }
            }
