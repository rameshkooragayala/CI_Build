...
//FullSanity-1201_PLB-Playback(EOF)& Trick modes SD-HD events
public class FullSanity_1201 : _Test
{
    [ThreadStatic]
    static _Platform CL;
    ...
    private class PreCondition : _Step
    {
        public override void Execute()
        {
            ...
            *************************************************/
            ...
            res = CL.EA.STBSettings.SetGuardTime(true, Sgt);
            if (!res.CommandSucceeded)
            {
                FailStep(CL, res, "Failed to set Sgt");
            }
            ...
            res = CL.EA.PVR.BookFutureEventFromBanner("SD_Event", 1, 5, true, false);
            if (!res.CommandSucceeded)
            {
            ...
            res = CL.EA.PVR.BookFutureEventFromBanner("HD_Event", 1, 5, false, true, false);
            if (!res.CommandSucceeded)
            {
    ...
    private class Step2 : _Step
    {
        ...
        public override void Execute()
        {
            ...
            // + -  6
            res = CL.EA.PVR.SetTrickModeSpeed("RB", 6, false);
            if (!res.CommandSucceeded)
            {
            ...
            // + -  12
            res = CL.EA.PVR.SetTrickModeSpeed("RB", 12, false);
            if (!res.CommandSucceeded)
            {
            ...
            // + -  30
            res = CL.EA.PVR.SetTrickModeSpeed("RB", 30, false);
            if (!res.CommandSucceeded)
            {
