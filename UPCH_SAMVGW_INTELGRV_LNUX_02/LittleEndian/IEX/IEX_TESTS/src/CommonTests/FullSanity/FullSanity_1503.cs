...
//FullSanity-1503-PC-Locked_Channel
public class FullSanity_1503 : _Test
{
    [ThreadStatic]
    static _Platform CL;
    ...
    public override void CreateStructure()
    {
        ...
        //Brief Description: FullSanity-01503-PC-Locked_Channel
    ...
    private class PreCondition : _Step
    {
        public override void Execute()
        {
            ...
            LockedChannel = CL.EA.GetValue("All_PC_Events_ch");
