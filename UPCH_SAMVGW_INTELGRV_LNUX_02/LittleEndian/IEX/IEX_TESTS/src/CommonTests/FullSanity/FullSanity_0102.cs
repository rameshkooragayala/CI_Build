...
//FULLSanity-0102-STB-Low Power Mode
public class FullSanity_0102 : _Test
{
    [ThreadStatic]
    static _Platform CL;
    ...
    {
        //Brief Description: FullSanity-102-STB-Low Power Mode
        //Pre-conditions: none.
    ...
    private class Step3 : _Step
    {
        public override void Execute()
        {
            ...
            res = CL.IEX.Debug.BeginWaitForMessage("IEX_SHUTDOWN_FAS", 0, 5 * 60, IEXGateway.DebugDevice.Udp);
            if (!res.CommandSucceeded)
            {
                FailStep(CL, res);
            }
