...
//FullSanity-0409-STC-StartChannelForCurrentProfile 
public class FullSanity_0409 : _Test
{
    [ThreadStatic]
    static _Platform CL;
    ...
    public override void CreateStructure()
    {
        ...
        this.AddStep(new Step4(), "Step 4:Reboot and Allow the box to complete Power cycle,Verify the Channel tuned is same as Last Channel->AV Service 2 ");
    ...
    public class Step4 : _Step
    {
        public override void Execute()
        {
            ...
            //Sending Retour key after exiting from Standby to refresh the EPG
            LogCommentInfo(CL, "Sending Retour key after exiting from Standby to refresh the EPG");
