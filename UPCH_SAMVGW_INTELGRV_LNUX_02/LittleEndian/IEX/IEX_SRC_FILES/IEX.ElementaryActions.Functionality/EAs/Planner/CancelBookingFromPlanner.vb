...
Namespace EAImplementation
    ...
    Public Class CancelBookingFromPlanner
        ...
        ''' </remarks>
        Sub New(ByVal EventKeyName As String, ByVal OccurrenceNumber As Integer, ByVal VerifyCancelInPCAT As Boolean, ByVal IsSeries As Boolean, ByVal IsComplete As Boolean, ByVal pManager As IEX.ElementaryActions.Functionality.Manager)
        ...
        Protected Overrides Sub Execute()
            ...
            EPG.FutureRecordings.SelectEvent("", _IsSeries)

            EPG.FutureRecordings.CancelEvent(True, _IsSeries, _IsComplete)
