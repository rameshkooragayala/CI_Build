...
Namespace EAImplementation
    ...
    Public Class CancelBookingFromBanner
        ...
        ''' </remarks>
        Sub New(ByVal EventKeyName As String, ByVal VerifyCancelInPCAT As Boolean, ByVal IsSeries As Boolean, ByVal IsComplete As Boolean, ByVal pManager As IEX.ElementaryActions.Functionality.Manager)
        ...
        Protected Overrides Sub Execute()
            ...
            EPG.Banner.CancelBooking(_IsSeries, _IsComplete)
