...
Namespace EAImplementation
    ...
    ''' </summary>
    Public Class CancelReminderFromGuide
        ...
        ''' </remarks>
        Sub New(ByVal EventKeyName As String, ByVal VerifyCanceledInPCAT As Boolean, ByVal ReturnToLive As Boolean, ByVal pManager As IEX.ElementaryActions.Functionality.Manager)
