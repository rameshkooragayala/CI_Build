Public Class CurrentRecordings
...
#Region "Get Subs"
    ...
    Overridable Sub NumberOfEvents(ByRef eventsNumber As Integer)
    ...
    Overridable Sub GetEventState(ByVal state As String)
...
#Region "Set Subs"
    ...
    Overridable Sub CancelEvent(Optional ByVal shouldSucceed As Boolean = True, Optional ByVal isSeriesEvent As Boolean = False, Optional ByVal isComplete As Boolean = True)
